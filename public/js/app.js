...
async function processPdfVisionEvidence(doc) {
  ...
  // Dựng lại doc.chunks từ evidence THÀNH CÔNG — thay hẳn chunk placeholder "📄 PDF này là bản
  // scan..." bằng nội dung thật, có page/sourceId/chunkIndex/totalChunks (mục A2) để tham gia
  // retrieveContext() như PDF chữ thường (mục A11).
