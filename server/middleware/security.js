...
const helmetConfig = helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'"],
      // FIX P0 mục 1: pdf.js dùng workerSrc = https://cdnjs.cloudflare.com/.../pdf.worker.min.js
      // (public/js/app.js dòng 3) — 'self'+blob: không đủ, worker bị CSP chặn. Thêm cdnjs cho khớp.
