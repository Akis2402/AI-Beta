...
// server/utils/aiProviders.js#buildKeyedVariants() tự tách thành nhiều "provider ảo" — MỖI khóa
// API trở thành 1 ứng viên độc lập trong vòng xoay ngẫu nhiên/đua tốc độ/failover (khóa nào hết
// hạn mức hoặc bị lỗi tự động nhường sang khóa khác CÙNG hãng hoặc hãng khác), còn model dùng cho
// mỗi lượt gọi được CHỌN NGẪU NHIÊN trong danh sách model đã khai — giúp vừa tăng độ tin cậy (nhiều
// khóa dự phòng) vừa tăng đa dạng câu trả lời (nhiều model) mà không cần sửa code. Chỉ khai 1
// khóa/1 model như trước đây thì hành vi giữ nguyên y hệt.
//
