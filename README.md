...
Tất cả dữ liệu cá nhân (quy tắc, cuộc trò chuyện, ghi chú, cài đặt) lưu trong `localStorage` của trình duyệt trên chính thiết bị đang dùng — ứng dụng không có tài khoản người dùng, không cần đăng nhập.
